...
class Yymmdd extends React.Component {
	constructor(props) {
      super(props);
          ...
          <div >
            ...
            >
              <div className="input-group" style={{width:'225px'}}>
                <input type="text" className="form-control" value={label} style={selectstyleYmd.inptstime}/>
              </div>
            </DatetimeRangePicker>
          </div>
        </div>
