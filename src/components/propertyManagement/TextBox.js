                        ...
                        <div className='modal-content' style={{
                            ...
                            <div className='modal-footer' style={styles.textBoxContent}>
                                <div style={styles.textBoxContentMiddle}>
                                    <div>
                                        <span style={styles.textBoxContentSingle}>订单号：</span>
                                        <span>30972857238057302457328479324723847384</span>
                                    </div>
                                    <div>
                                    ...
                                    <div>
                                        <span style={styles.textBoxContentSingle}>联系电话：</span>
                                        <span>14300009999</span>
                                    </div>
                                    <div>
                                        <span style={styles.textBoxContentSingle}>交易类型：</span>
                                        <span>停车场自动扣停车费</span>
                                    </div>
                                    <div>
                                        <span style={styles.textBoxContentSingle}>订单金额(元)：</span>
                                        <span>0.0</span>
                                    </div>
                                    <div>
                                    ...
                                    <div>
                                        <span style={styles.textBoxContentSingle}>交易金额(元)：</span>
                                        <span>35.00</span>
                                    </div>
                                    <div>
                                        <span style={styles.textBoxContentSingle}>订单状态：</span>
                                        <span>交易完成</span>
                                    </div>
                                    <div>
                                        <span style={styles.textBoxContentSingle}>下单时间：</span>
                                        <span>2017-02-08 20:59:37</span>
                                    </div>
                                    <div>
                                        <span style={styles.textBoxContentSingle}>入场时间：</span>
                                        <span>2017-02-08 20:59:37</span>
                                    </div>
                                    <div>
                                        <span style={styles.textBoxContentSingle}>出场时间：</span>
                                        <span>2017-02-08 20:59:49</span>
                                    </div>
                                    <div>
