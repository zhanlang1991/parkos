...
import {queryEscapeRepayParkSerial} from '../../../request/queryEscapeRepayParkSerial'
//补交流水
class FillBill extends React.Component {
    constructor() {
        super();
        this.state = {
            parksData: {details:[]},
    ...
    parkRequest() {
		...
		queryEscapeRepayParkSerial(reqData, cust_id, session)
		.then((res) => {
			console.log(res);
		});
    }
